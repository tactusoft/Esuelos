package co.emes.esuelos.fileselector;
...
public class FileSelector {
	...
	public FileSelector(final Context context, final FileOperation operation,
		...
		mDialog.setContentView(R.layout.file_selector);
	...
	private void setSaveLoadButton(final FileOperation operation) {
		...
		mSaveLoadButton.setTransformationMethod(null);
		switch (operation) {
		case SAVE:
	...
	private void setNewFolderButton(final FileOperation operation) {
        ...
        mNewFolderButton.setTransformationMethod(null);
